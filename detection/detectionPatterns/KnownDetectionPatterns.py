...
class KnownDetectionPatterns:
    ...
    def __init__(self):
        ...
        distil_CDN =        DetectionPatternFactory.createDetectionPattern(score, 'Distil_CDN', [[re.escape('|| window._phantom || window.__phantomas || window.callPhantom || 0 == navigator.onLine &&'), 'n-distil.areyouahuman.com']], None, True)
        ...
        self.patterns.extend((distilDetection1, distilDetection2, distil_CDN, perimeterX))