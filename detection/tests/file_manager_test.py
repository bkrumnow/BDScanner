...
class FileManagerTest(unittest.TestCase):
    ...
    def test_extractFileName(self):
        ...
        self.assertEqual(
            FileManager.extractFileName("https://example.com/analytics/comscore-streaming.js"),
            "comscore-streaming.js"
        )
            
        # ? and is prohibited
        self.assertEqual(
            FileManager.extractFileName("https://example.com/site/50550?ret=js&limit=1.js"),
            "50550-ret=js-limit=1.js"
        )
        
        # js is appended when it is missing
        self.assertEqual(
            FileManager.extractFileName("https://example.com/site/50550ret=jslimit=1"),
            "50550ret=jslimit=1.js"
        )
        
        # Not longer than 20 characters + charatercs file extension
        self.assertEqual(
            len(FileManager.extractFileName("https://example.com?id=GTM-P528B3&gtm_auth=tfAzqo1rYDLgYhmTnSjPqw&gtm_preview=env-130&gtm_cookies_win=x")),
            23
        )
